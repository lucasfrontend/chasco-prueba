                ...
                <div className="activity card">
                    <form className="space-y-4" onSubmit={handleSubmit}>
                        ...
                        <div className="bg-dark p-2 w-full flex flex-col rounded-md dark:bg-gray-800 shadow">
                            <input name="name_deudor" placeholder="Nombre" type="text" className="bg-dark w-full flex flex-col rounded-md dark:bg-gray-800 shadow" onChange={handleChange} value={formData.name_deudor}>
                            </input>
                        </div>
                        <div className="bg-dark p-2 w-full flex flex-col rounded-md dark:bg-gray-800 shadow">
                            <input name="description" placeholder="Descripcion" type="text" className="bg-dark w-full flex flex-col rounded-md dark:bg-gray-800 shadow" onChange={handleChange} value={formData.description}>
                            </input>
                        </div>
                        <span>Opcional</span>
