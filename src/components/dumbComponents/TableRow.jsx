    ...
    return <>
        <tr className=" flex justify-between border border-slate-300">
            ...
            <td className=" px-5 py-3 flex cursor-pointer">
                <button className="bg-transparent hover:bg-active hover:text-white cursor-pointer font-semibold py-2 px-4 border border-gray-400 rounded shadow mr-4" onClick={() => setEditData(el)}> 
                    <div className="fill-green w-4"  className="w-4 cursor-pointer fill-white ">
