    ...
    */
    ...
    if(loading === true){
        ...
        <div className="bg-weather">
          <div classNameName="flex-grow container mx-auto sm:px-4 pt-6 pb-8">
            <WeatherCard 
                  show={show}
                  loading={loading}
                  weather={weather}
            ...
            {/* card 2 */}
              <div className="flex flex-wrap">
                ...
                <div className="flex-grow flex flex-col backdrop-blur border-t border-b sm:rounded sm:border shadow overflow-hidden">
                <div className="border-b">
                <div className="flex justify-between px-6 -mb-px">
                  <h3 className="text-blue-dark py-4 font-normal text-lg">lorem</h3>
                  <div className="flex">
                    <button type="button" className="appearance-none py-4 text-blue-dark border-b border-blue-dark mr-3">
                    lorem
                                        </button>
                    <button type="button" className="appearance-none py-4 text-grey-dark border-b border-transparent hover:border-grey-dark">
                    lorem
                                        </button>
                  </div>
                </div>
                ...
                <div className="w-2/5 xl:w-1/4 px-4 flex items-center">
                  ...
                  <span className="text-lg">ll</span>
                </div>
                <div className="hidden md:flex lg:hidden xl:flex w-1/4 px-4 items-center">
                ...
                <div className="w-2/5 xl:w-1/4 px-4 flex items-center">
                  ...
                  <span className="text-lg">ggg</span>
                </div>
                <div className="hidden md:flex lg:hidden xl:flex w-1/4 px-4 items-center">
                ...
                <div className="backdrop-blur border-t border-b sm:rounded sm:border shadow">
                <div className="border-b">
                <div className="flex justify-between px-6 -mb-px">
                  <h3 className="text-blue-dark py-4 font-normal text-lg">Prono prox</h3>
                </div>
                </div>
                <div>
                <div className="text-center px-6 py-4">
                  <div className="py-8">
                    ...
                    <p className="text-2xl text-grey-darker font-medium mb-4">descrip</p>
                    <p className="text-grey max-w-xs mx-auto mb-6">data api</p>
                    <div>
                      <button type="button" className="bg-blue hover:bg-blue-dark text-white border border-blue-dark rounded px-6 py-4">bla</button>
                    </div>
                  </div>
                </div>
                </div>
