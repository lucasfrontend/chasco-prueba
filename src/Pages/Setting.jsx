                ...
                <div className="activity card bg-lightest">
                    ...
                    <form className="space-y-4">
                        ...
                        <div className="flex justify-end">
                            ...
                            <input className="bg-transparent hover:bg-active hover:text-white cursor-pointer font-semibold py-2 px-4 border border-gray-400 rounded shadow text-white" type="reset" value="Reset"/>
                        </div>
                    </form>
                </div>
            </div>
